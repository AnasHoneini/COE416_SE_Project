...
data class Grade7NineModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtGrCounter: String? = MyApp.getInstance().resources.getString(R.string.lbl_gr_9)
  ,
  /**
   * TODO Replace with dynamic value
   */
